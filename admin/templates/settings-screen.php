...
<div class="wrap">
    ...
    <div id="settings-wrapper">
        ...
        <ul id="settings-tabs">
            <li class="<?php if( $current_tab == 'settings') echo 'active';?> "><a href="<?php echo $tab_url;?>settings"  > 
            ...
            <?php elseif( $current_tab == 'icons'):?>
                ...
                <div class="section cards mb-50">
                    ...
                    <div class="section-contents">
                        ...
                        <div id="available-icons-container"></div> <!--icons-container-->
                ...
                <div class="section cards " id="selected-icons-section" style="display: none;" >
                    ...
                    <div class="section-contents">
                        <div id="selected-icons-container"></div> <!--icons-container-->
                    </div> <!--section-contents-->
